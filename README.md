...
```bash
cd /projects/ttan/tigrbid-QC
streamlit run ./data/fmriprep/fmriprep_main.py -- --fmri_dir /projects/galinejad/SCanD_CAMH_RTMSWM/share/fmriprep/23.2.3 --participant_labels /projects/ttan/RTMSWM/participants.tsv --output_dir /projects/ttan/tigrbid-QC/outputs/RTMSWM_QC/
```
...
cd /projects/ttan/tigrbid-QC
streamlit run ./data/freesurfer/fs_main.py --server.port=8501 -- \
